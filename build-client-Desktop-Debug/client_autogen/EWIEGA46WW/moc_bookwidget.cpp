...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BookWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BookWidget_t qt_meta_stringdata_BookWidget = {
    {
        QT_MOC_LITERAL(0, 10)   // "BookWidget"
    },
    "BookWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_BookWidget[] = {
...
Q_CONSTINIT const QMetaObject BookWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_BookWidget.offsetsAndSizes,
    qt_meta_data_BookWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BookWidget_t,
        // Q_OBJECT / Q_GADGET
